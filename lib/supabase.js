...
export async function addToolChange(toolChangeData) {
  try {
    ...
    // Map data to match your EXACT database schema
    const mappedData = {
      // Basic information - these fields exist
      ...
      // Equipment and operation - these fields exist  
      ...
      // Enhanced tool information - using CORRECT field names from your schema
      ...
      // Change reasons - using CORRECT field names
      ...
      operator_observations: toolChangeData.operator_observations,
    ...
    console.log('📦 Mapped data for database:', cleanData);
