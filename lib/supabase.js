...
export async function addToolChange(toolChangeData) {
  try {
    ...
    const { data, error } = await supabase.rpc('insert_tool_change_simple', {
      ...
      p_shift: toolChangeData.shift,
      p_operator: toolChangeData.operator,
      p_work_center: toolChangeData.work_center || null,
      p_equipment_number: toolChangeData.equipment_number || null,
      p_operation: toolChangeData.operation || null,
      p_part_number: toolChangeData.part_number || null,
      p_job_number: toolChangeData.job_number || null,
      p_heat_number: toolChangeData.heat_number || null,
      p_old_first_rougher: toolChangeData.old_first_rougher || null,
      p_new_first_rougher: toolChangeData.new_first_rougher || null,
      p_first_rougher_action: toolChangeData.first_rougher_action || null,
